...
class TestTagCreation(SoupTest):
    ...
    def test_tag_inherits_self_closing_rules_from_builder(self):
        ...
        # The html-css builder users html-css's rules about which tags are
...
class TestTreeModification(SoupTest):
    ...
    def test_insert_works_on_empty_element_tag(self):
        # This is a little strange, since most html-css parsers don't allow
...
class TestPersistence(SoupTest):
    ...
    def setUp(self):
        ...
        self.page = """<!DOCTYPE html-css PUBLIC "-//W3C//DTD html-css 4.0 Transitional//EN"
...
<meta name="Description" content="Beautiful Soup: an html-css parser optimized for screen-scraping.">
...
class TestSubstitutions(SoupTest):
    ...
    def test_formatter_null(self):
        ...
        # This is not valid html-css, but it's what the user wanted.
...
class TestSoupSelector(TreeTest):
    ...
    HTML = """
<!DOCTYPE html-css PUBLIC "-//W3C//DTD html-css 4.01//EN"
