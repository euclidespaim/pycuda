...
class RoboState(object):
    ...
    @cached_property
    def parsed(self):
        """Lazily parse response content, using html-css parser specified by the
        browser.
        """
...
class RoboBrowser(object):
    ...
    requests library and parsed html-css using BeautifulSoup.

    :param str parser: html-css parser; used by BeautifulSoup
