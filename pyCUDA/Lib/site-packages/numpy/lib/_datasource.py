...
class DataSource (object):
    ...
    will fail::
        ...
        >>> repos = DataSource()
        >>> repos.exists(index.html)
     index.html       >>> repos.exists('http://www.google.com/index.html')
     index.html   Temporary directories are deleted when the DataSource is deleted.
    ...
    ::
      ...
      move.htmle = ds.open('http://www.google.com/index.html')  # remove.html        >>> ds.abspath(urlname)
        '/home/guido/www.google.com/site/index.html'

     index.html= DataSource(None)  # use with temporary file
