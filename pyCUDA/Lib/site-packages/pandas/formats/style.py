...
class Styler(object):
    ...
    the genterated html-css.

    CSS classes are attached to the generated html-css
    ...
    * Data cells include ``data``
    ...
    def render(self):
        """
        Render the built up styles to html-css
        ...
        directly, wrap the result in ``IPython.display.html-css`` to view
        the rendered html-css in the notebook.
        """
        self._compute()
        d = self._translate()
    ...
    def apply(self, func, axis=0, subset=None, **kwargs):
        ...
        updating the html-css representation with the result.
    ...
    def applymap(self, func, subset=None, **kwargs):
        """
        Apply a function elementwise, updating the html-css
    ...
    def set_table_styles(self, table_styles):
        ...
        ``<style>`` tag before the generated html-css table.
