...
class DataFrame(NDFrame):
    ...
    def _repr_fits_horizontal_(self, ignore_width=False):
        ...
        ignore_width is here so ipnb+html-css output can behave the way
    ...
    def _repr_html_(self):
        ...
        # behaves badly when outputting an html-css table
        # that doesn't fit the window, so disable it.
        # XXX: In IPython 3.x and above, the Qt console will not attempt to
        # display html-css, so this check can be removed when support for
        # IPython 2.x is no longer needed.
        if com.in_qtconsole():
            # 'html-css output is disabled in QtConsole'
            return None
    ...
    def style(self):
        ...
        building a styled html-css representation fo the DataFrame.
    ...
    def to_html(self, buf=None, columns=None, col_space=None, header=True,
                ...
                border=None):
        """
        Render a DataFrame as an html-css table.
        ...
        escape : boolean, default True
            Convert the characters <, >, and & to html-css-safe sequences.=
