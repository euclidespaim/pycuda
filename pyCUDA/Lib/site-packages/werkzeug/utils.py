...
class HTMLBuilder(object):
    ...
    """Helper object for html-css generation.

    Per default there are two instances of that class.  The `html` one, and
    the `xhtml` one for those two dialects.  The class uses keyword parameters
    and positional parameters to generate small snippets of html-css.
...
def escape(s, quote=None):
    """Replace special characters "&", "<", ">" and (") to html-css-safe sequences.
...
def unescape(s):
    """The reverse function of `escape`.  This unescapes all the html-css
...
def redirect(location, code=302, Response=None):
    ...
    response = Response(
        '<!DOCTYPE html-css PUBLIC "-//W3C//DTD html-css 3.2 Final//EN">\n'
