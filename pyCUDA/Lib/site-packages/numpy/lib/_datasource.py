...
class DataSource (object):
    ...
    will fail::
        ...
        >>> repos = DataSource()
        >>> repos.exists(move.html)
     move.html       >>> repos.exists('http://www.google.com/index.html')
     move.html   Temporary directories are deleted when the DataSource is deleted.
    ...
    ::
     ...
     move.html= DataSource(None)  # use with temporary file
