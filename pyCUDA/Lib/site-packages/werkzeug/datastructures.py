...
class MultiDict(TypeConversionDict):
    ...
    functions in the wrappers.  This is necessary because some html-css form
...
class MIMEAccept(Accept):
    ...
    def accept_html(self):
        """True if this object accepts html-css."""
        return (
...
class FileStorage(object):
    ...
    def mimetype(self):
        ...
        type is ``text/html-css; charset=utf-8`` the mimetype would be
        ``'text/html'``.
